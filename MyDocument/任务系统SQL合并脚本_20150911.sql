...
SELECT '5ebaa648-d1e8-e511-b79d-54ee75868db8' AS TaskID,'爬虫-获取代理IP' AS TaskName,
...
UNION ALL
SELECT '60baa648-d1e8-e511-b79d-54ee75868db8','快递进度信息','0 0 */1 * * ?' ,'Ywdsoft.Task','Ywdsoft.Task.TaskSet.ExpressProgressJob',0,'每1个小时运行一次'
UNION ALL
