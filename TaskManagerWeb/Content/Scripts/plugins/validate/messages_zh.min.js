...
! function (a) {
    ...
    // 中文字三个字节
    a.validator.addMethod("byteMaxLength", function (value, element, param) {
    ...
    }, a.validator.format(icon + "最多输入{0}个字节(一个中文字算3个字节)"));

    // 中文字三个字节
    a.validator.addMethod("alnum", function (value, element, param) {
        return this.optional(element) || /^[a-zA-Z0-9]+$/.test(value);
    }, a.validator.format(icon + "只能包括英文字母和数字"));
    ...
    a.extend(a.validator.messages, {
        ...
        alnum: icon + "只能包括英文字母和数字",
        ip: icon + "Ip地址格式错误",
        repaswd: icon + "确认密码与新密码不一致！",
        ...
        ipv4: a.validator.format(icon + "请输入正确的ipv4地址")
    })
});